...
@__DSOCacheEntry_name.2 = internal constant [38 x i8] c"libaot-FFImageLoading.Platform.dll.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [35 x i8] c"libaot-FFImageLoading.Forms.dll.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [43 x i8] c"libaot-DevExpress.Mobile.Core.v17.1.dll.so\00", align 1
...
@__DSOCacheEntry_name.9 = internal constant [41 x i8] c"libaot-System.Net.Http.Primitives.dll.so\00", align 1
@__DSOCacheEntry_name.10 = internal constant [41 x i8] c"libaot-FFImageLoading.Forms.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.11 = internal constant [42 x i8] c"libaot-UXDivers.Artina.Shared.Base.dll.so\00", align 1
@__DSOCacheEntry_name.12 = internal constant [30 x i8] c"libaot-Newtonsoft.Json.dll.so\00", align 1
@__DSOCacheEntry_name.13 = internal constant [50 x i8] c"libaot-Xamarin.Android.Support.v7.CardView.dll.so\00", align 1
@__DSOCacheEntry_name.14 = internal constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 1
...
@__DSOCacheEntry_name.19 = internal constant [43 x i8] c"libaot-UXDivers.Artina.Shared.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.20 = internal constant [26 x i8] c"libaot-System.Data.dll.so\00", align 1
@__DSOCacheEntry_name.21 = internal constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Maps.dll.so\00", align 1
@__DSOCacheEntry_name.22 = internal constant [26 x i8] c"libaot-System.Core.dll.so\00", align 1
@__DSOCacheEntry_name.23 = internal constant [63 x i8] c"libaot-Xamarin.Android.Support.Animated.Vector.Drawable.dll.so\00", align 1
@__DSOCacheEntry_name.24 = internal constant [45 x i8] c"libaot-FFImageLoading.Transformations.dll.so\00", align 1
@__DSOCacheEntry_name.25 = internal constant [41 x i8] c"libaot-Xamarin.Forms.Maps.Android.dll.so\00", align 1
...
@__DSOCacheEntry_name.28 = internal constant [47 x i8] c"libaot-Xamarin.Android.Arch.Core.Common.dll.so\00", align 1
@__DSOCacheEntry_name.29 = internal constant [21 x i8] c"libaot-Lottie.dll.so\00", align 1
@__DSOCacheEntry_name.30 = internal constant [40 x i8] c"libaot-Toasts.Forms.Plugin.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.31 = internal constant [47 x i8] c"libaot-Xamarin.Android.Support.Fragment.dll.so\00", align 1
@__DSOCacheEntry_name.32 = internal constant [49 x i8] c"libaot-Xamarin.Android.Support.Core.Utils.dll.so\00", align 1
@__DSOCacheEntry_name.33 = internal constant [47 x i8] c"libaot-Toasts.Forms.Plugin.Abstractions.dll.so\00", align 1
@__DSOCacheEntry_name.34 = internal constant [30 x i8] c"libaot-Plugin.Settings.dll.so\00", align 1
@__DSOCacheEntry_name.35 = internal constant [18 x i8] c"libmono-native.so\00", align 1
@__DSOCacheEntry_name.36 = internal constant [51 x i8] c"libaot-Xamarin.Android.Support.v7.AppCompat.dll.so\00", align 1
@__DSOCacheEntry_name.37 = internal constant [35 x i8] c"libaot-SocketIoClientDotNet.dll.so\00", align 1
@__DSOCacheEntry_name.38 = internal constant [46 x i8] c"libaot-Plugin.Permissions.Abstractions.dll.so\00", align 1
@__DSOCacheEntry_name.39 = internal constant [24 x i8] c"libmono-profiler-log.so\00", align 1
@__DSOCacheEntry_name.40 = internal constant [37 x i8] c"libaot-Plugin.CurrentActivity.dll.so\00", align 1
@__DSOCacheEntry_name.41 = internal constant [25 x i8] c"libaot-System.Xml.dll.so\00", align 1
@__DSOCacheEntry_name.42 = internal constant [54 x i8] c"libaot-Xamarin.Android.Support.Vector.Drawable.dll.so\00", align 1
@__DSOCacheEntry_name.43 = internal constant [27 x i8] c"libaot-Lottie.Forms.dll.so\00", align 1
@__DSOCacheEntry_name.44 = internal constant [43 x i8] c"libaot-Plugin.Settings.Abstractions.dll.so\00", align 1
@__DSOCacheEntry_name.45 = internal constant [33 x i8] c"libaot-Xamarin.Forms.Xaml.dll.so\00", align 1
@__DSOCacheEntry_name.46 = internal constant [50 x i8] c"libaot-Xamarin.Android.Support.Annotations.dll.so\00", align 1
@__DSOCacheEntry_name.47 = internal constant [31 x i8] c"libxamarin-debug-app-helper.so\00", align 1
@__DSOCacheEntry_name.48 = internal constant [45 x i8] c"libaot-Xamarin.Forms.Platform.Android.dll.so\00", align 1
@__DSOCacheEntry_name.49 = internal constant [51 x i8] c"libaot-DevExpress.Mobile.Grid.Android.v17.1.dll.so\00", align 1
@__DSOCacheEntry_name.50 = internal constant [28 x i8] c"libaot-WebSocket4Net.dll.so\00", align 1
@__DSOCacheEntry_name.51 = internal constant [35 x i8] c"libaot-EngineIoClientDotNet.dll.so\00", align 1
@__DSOCacheEntry_name.52 = internal constant [21 x i8] c"libaot-System.dll.so\00", align 1
@__DSOCacheEntry_name.53 = internal constant [33 x i8] c"libaot-Plugin.Permissions.dll.so\00", align 1
@__DSOCacheEntry_name.54 = internal constant [33 x i8] c"libaot-Lottie.Forms.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.55 = internal constant [40 x i8] c"libaot-Plugin.Media.Abstractions.dll.so\00", align 1
@__DSOCacheEntry_name.56 = internal constant [39 x i8] c"libaot-CasosTotalizadores.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.57 = internal constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 1
@__DSOCacheEntry_name.58 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 1
@__DSOCacheEntry_name.59 = internal constant [33 x i8] c"libaot-CasosTotalizadores.dll.so\00", align 1
@__DSOCacheEntry_name.60 = internal constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Basement.dll.so\00", align 1
@__DSOCacheEntry_name.61 = internal constant [49 x i8] c"libaot-Xamarin.Android.Support.Transition.dll.so\00", align 1
@__DSOCacheEntry_name.62 = internal constant [33 x i8] c"libaot-Xamarin.Forms.Maps.dll.so\00", align 1
@__DSOCacheEntry_name.63 = internal constant [30 x i8] c"libaot-System.Numerics.dll.so\00", align 1
@__DSOCacheEntry_name.64 = internal constant [31 x i8] c"libaot-UXDivers.Effects.dll.so\00", align 1
@__DSOCacheEntry_name.65 = internal constant [43 x i8] c"libaot-System.Runtime.Serialization.dll.so\00", align 1
@__DSOCacheEntry_name.66 = internal constant [27 x i8] c"libaot-Plugin.Media.dll.so\00", align 1
@__DSOCacheEntry_name.67 = internal constant [51 x i8] c"libaot-DevExpress.Mobile.Core.Android.v17.1.dll.so\00", align 1
@__DSOCacheEntry_name.68 = internal constant [48 x i8] c"libaot-UXDivers.Artina.Shared.Base.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.69 = internal constant [34 x i8] c"libaot-Plugin.Connectivity.dll.so\00", align 1
@__DSOCacheEntry_name.70 = internal constant [53 x i8] c"libaot-Xamarin.Android.Arch.Lifecycle.Runtime.dll.so\00", align 1
@__DSOCacheEntry_name.71 = internal constant [47 x i8] c"libaot-Plugin.Connectivity.Abstractions.dll.so\00", align 1
@__DSOCacheEntry_name.72 = internal constant [53 x i8] c"libaot-Xamarin.Android.Support.v7.MediaRouter.dll.so\00", align 1
@__DSOCacheEntry_name.73 = internal constant [45 x i8] c"libaot-Xamarin.Android.Support.Design.dll.so\00", align 1
@__DSOCacheEntry_name.74 = internal constant [29 x i8] c"libaot-FormsViewGroup.dll.so\00", align 1
@__DSOCacheEntry_name.75 = internal constant [52 x i8] c"libaot-Xamarin.Android.Arch.Lifecycle.Common.dll.so\00", align 1
@__DSOCacheEntry_name.76 = internal constant [29 x i8] c"libaot-FFImageLoading.dll.so\00", align 1
@__DSOCacheEntry_name.77 = internal constant [41 x i8] c"libaot-System.Net.Http.Extensions.dll.so\00", align 1
@__DSOCacheEntry_name.78 = internal constant [54 x i8] c"libaot-Xamarin.Android.Support.v7.RecyclerView.dll.so\00", align 1
@__DSOCacheEntry_name.79 = internal constant [46 x i8] c"libaot-Xamarin.Android.Support.Core.UI.dll.so\00", align 1
@__DSOCacheEntry_name.80 = internal constant [41 x i8] c"libaot-Xamarin.Android.Support.v4.dll.so\00", align 1
@__DSOCacheEntry_name.81 = internal constant [43 x i8] c"libaot-DevExpress.Mobile.Grid.v17.1.dll.so\00", align 1
@__DSOCacheEntry_name.82 = internal constant [49 x i8] c"libaot-Xamarin.Android.Support.v7.Palette.dll.so\00", align 1
@__DSOCacheEntry_name.83 = internal constant [37 x i8] c"libaot-UXDivers.Effects.Droid.dll.so\00", align 1
@__DSOCacheEntry_name.84 = internal constant [45 x i8] c"libaot-Xamarin.Android.Support.Compat.dll.so\00", align 1
...
@__DSOCacheEntry_name.87 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 1
@__DSOCacheEntry_name.88 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 1
@__DSOCacheEntry_name.89 = internal constant [37 x i8] c"libaot-UXDivers.Artina.Shared.dll.so\00", align 1
