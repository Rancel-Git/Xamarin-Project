...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("UXDivers.Artina.Shared.ArtinaEntryRenderer, UXDivers.Artina.Shared.Droid, Version=2.5.2.0, Culture=neutral, PublicKeyToken=null", ArtinaEntryRenderer.class, __md_methods);
	}
	...
	public ArtinaEntryRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == ArtinaEntryRenderer.class)
			mono.android.TypeManager.Activate ("UXDivers.Artina.Shared.ArtinaEntryRenderer, UXDivers.Artina.Shared.Droid, Version=2.5.2.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
